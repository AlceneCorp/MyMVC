...
/**
 * Class MenuManager
 * Cette classe gère les opérations liées à la manipulation des instances de Menu dans la base de données.
 */
class MenuManager extends DatabaseManager
{
    /**
     * Récupère une seule instance de Menu à partir de la base de données.
     * 
     ...
     * @return Menu|null Retourne une instance de Menu ou null si aucune correspondance.
     */
    ...
    /**
     * Récupère toutes les instances de Menu à partir de la base de données.
     * 
     * @param array $param_Data Données à utiliser pour filtrer la recherche.
     * @param array $param_Parameters Paramètres supplémentaires pour la requête.
     * @return array Tableau d'instances de Menu.
     */
    ...
    /**
     * Ajoute une nouvelle instance de Menu dans la base de données.
     * 
    ...
    /**
     * Met à jour une instance de Menu dans la base de données.
     * 
    ...
    /**
     * Supprime une instance de Menu dans la base de données.
     * 
    ...
    /**
     * Compte le nombre d'enregistrements de Menu dans la base de données en fonction des paramètres.
     * 
