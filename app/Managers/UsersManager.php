...
/**
 * Class UsersManager
 * Cette classe gère les opérations liées à la manipulation des instances de Users dans la base de données.
 */
class UsersManager extends DatabaseManager
{
    /**
     * Récupère une seule instance de Users à partir de la base de données.
     * 
     ...
     * @param array $param_Data Données à utiliser pour filtrer la recherche.
     * @param array $param_Parameters Paramètres supplémentaires pour la requête.
     * @return array Tableau d'instances de Users.
     */
    ...
    /**
     * Ajoute une nouvelle instance de Users dans la base de données.
     * 
    ...
    /**
     * Met à jour une instance de Users dans la base de données.
     * 
    ...
    /**
     * Supprime une instance de Users dans la base de données.
     * 
    ...
    /**
     * Compte le nombre d'enregistrements de Users dans la base de données en fonction des paramètres.
     * 
