 ...
 * Cette classe gère les opérations liées à la manipulation des instances de Permissions dans la base de données.
 */
class PermissionsManager extends DatabaseManager
{
    /**
     * Récupère une seule instance de Permissions à partir de la base de données.
     * 
     ...
     * @return Permissions|null Retourne une instance de Permissions ou null si aucune correspondance.
     */
    ...
    /**
     * Récupère une seule instance de Permissions avec une recherche signée dans la base de données.
     * 
     * Cette méthode est utilisée pour effectuer une recherche dans la table permissions avec une logique spécifique liée aux "signatures" (signées).
     * Elle retourne une seule instance de Permissions ou null si aucune correspondance n'est trouvée.
     * 
     * @param array $param_Data Données à utiliser pour filtrer la recherche.
     * @param array $param_Parameters Paramètres supplémentaires pour la requête.
     * @return Permissions|null Retourne une instance de Permissions ou null si aucune correspondance.
     */
    public function findOneSignPermissions(array $param_Data = [], array $param_Parameters = []) : ?Permissions
    {
        // Appel à la méthode findOne de DatabaseManager avec les paramètres nécessaires pour rechercher une seule entrée dans la table
        return parent::findOneSign('permissions', Permissions::class, $param_Data, $param_Parameters);
    }

    /**
     * Récupère toutes les instances de Permissions à partir de la base de données.
     * 
     * @param array $param_Data Données à utiliser pour filtrer la recherche.
     * @param array $param_Parameters Paramètres supplémentaires pour la requête.
     * @return array Tableau d'instances de Permissions.
     */
    ...
    /**
     * Ajoute une nouvelle instance de Permissions dans la base de données.
     * 
    ...
    /**
     * Met à jour une instance de Permissions dans la base de données.
     * 
    ...
    /**
     * Supprime une instance de Permissions dans la base de données.
     * 
    ...
    /**
     * Compte le nombre d'enregistrements de Permissions dans la base de données en fonction des paramètres.
     * 
     ...
     */
    public function countPermissions(array $param_Data = [], array $param_Parameters = []) : int
    {
        return parent::count('permissions', Permissions::class, $param_Data, $param_Parameters);
    }

    /**
     * Vide (TRUNCATE) la table permissions.
     * 
